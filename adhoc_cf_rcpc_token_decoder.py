...
def cipher_decode(raw_cipher):
    ...
    key = [233, 238, 75, 3, 193, 208, 130, 41,
           135, 24, 93, 39, 188, 162, 51, 120]
    iv = [24, 143, 175, 219, 224, 248, 126,
          240, 252, 40, 16, 213, 179, 227, 71, 5]
    mode = 2
    orig_len = 16
    decoded = aes.decrypt(raw_cipher, orig_len, mode, key,
